    ...
    deal: function (system, context) {
      ...
      if (dist > 0) {
        if (context.totalSize <= GW.balance.numberOfSystems[0]) {
          chance = 50;
          if (dist > 2) chance = 500;
          else if (dist > 4) chance = 250;
        } else if (context.totalSize <= GW.balance.numberOfSystems[1]) {
          chance = 50;
          if (dist > 3) chance = 500;
          else if (dist > 6) chance = 250;
        } else if (context.totalSize <= GW.balance.numberOfSystems[2]) {
          chance = 50;
          if (dist > 5) chance = 500;
          else if (dist > 9) chance = 250;
        } else if (context.totalSize <= GW.balance.numberOfSystems[3]) {
          chance = 50;
          if (dist > 6) chance = 500;
          else if (dist > 10) chance = 250;
        } else {
          chance = 50;
          if (dist > 7) chance = 500;
          else if (dist > 12) chance = 250;
        }
      }
      return { chance: chance };
    },
    buff: function (inventory) {
      var units = ["/pa/tools/commander_build_arm/commander_build_arm.json"];
      var mods = [];
